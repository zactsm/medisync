...
use App\Models\{ActivityLog, Appointment, CaregiverLink, Medication, MedicalDocument, MedicalProfile, Notification, SymptomReport, User};
...
class MediSyncApiController extends Controller
{
    ...
    { ActivityLog::create(['user_id'=>$patient->id,'actor_id'=>($actor ?? $patient)->id,'action'=>$action,'subject_type'=>$subject ? $subject::class : null,'subject_id'=>$subject?->id]); }
