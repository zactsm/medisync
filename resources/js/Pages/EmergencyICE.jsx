...
export default function EmergencyICE({ user, patientICE }) {
    ...
    return (
        <AppLayout user={user}>
            <Head title="Pengurusan Profil Kecemasan (ICE)" />
            ...
            <div className="mb-6 p-6 rounded-2xl bg-gradient-to-r from-rose-950 via-slate-900 to-slate-900 border border-rose-500/40 shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        <Badge variant="red">Lockscreen Emergency ICE</Badge>
                        <span className="text-xs text-slate-400 font-mono">ID Khas: {iceData.publicAccessCode}</span>
                    </div>
                    <h1 className="text-2xl font-black text-white">Profil Kecemasan In-Case-of-Emergency (ICE)</h1>
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="glass-card p-6 rounded-2xl border-slate-700/60 space-y-4">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            ...
                            <div>
                                <label className="block text-xs font-semibold text-slate-400 mb-1">Penderma Organ</label>
                                <select
                                ...
                                >
                                    <option value="Ya">Ya (Berikrar)</option>
                                    <option value="Tidak">Tidak</option>
                                </select>
                            </div>
                            <div>
                                <label className="block text-xs font-semibold text-slate-400 mb-1">Berat (kg)</label>
                                <input
                                    type="number"
                            ...
                            <div>
                                <label className="block text-xs font-semibold text-slate-400 mb-1">Tinggi (cm)</label>
                                <input
                                    type="number"
                    ...
                    <div className="glass-card p-6 rounded-2xl border-rose-500/30 space-y-4">
                        <h3 className="text-lg font-bold text-white border-b border-slate-800 pb-3 flex items-center gap-2">
                            ...
                            Penyakit Kronik & Alahan Kritikal
                        </h3>
                        ...
                        <div className="pt-2">
                            <label className="block text-xs font-semibold text-slate-300 mb-1">Sejarah Perubatan / Penyakit Kronik</label>
                    ...
                    <div className="glass-card p-6 rounded-2xl border-slate-700/60 space-y-4">
                        <h3 className="text-lg font-bold text-white border-b border-slate-800 pb-3 flex items-center gap-2">
                            ...
                            Ubat Harian Yang Sedang Diambil
                        </h3>
                            ...
                            {iceData.vitalMedications?.map((med, i) => (
                                <div key={i} className="p-3 rounded-xl bg-slate-800/80 border border-slate-700/60 flex items-center justify-between text-xs">
                                    <div>
                                        ...
                                        <span className="text-slate-400 block text-[11px]">Tujuan: {med.purpose}</span>
                                    </div>
                ...
                <div className="space-y-6">
                    <div className="glass-card p-6 rounded-2xl border-slate-700/60 space-y-4">
                        <h4 className="text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2">
                            <Lock className="w-4 h-4 text-teal-400" /> Kawalan Akses Awam
                        </h4>

                        <p className="text-xs text-slate-300 leading-relaxed">
                            Mod Akses Awam mengehadkan fail peribadi, nombor insurans, dan sebarang dokumen sulit pesakit. Hanya data keselamatan nyawa yang ditunjukkan.
                        </p>

                        <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 text-center">
                            <QrCode className="w-16 h-16 text-teal-400 mx-auto mb-2" />
                            <span className="text-[10px] text-slate-400 uppercase font-mono">Pautan Pantas Kecemasan</span>
                        ...
                        >
                            ...
                            {saved ? 'Profil Disimpan!' : 'Kemaskini Profil ICE'}
                        </button>
                    </div>
                </div>
            </form>
